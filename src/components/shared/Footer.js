...
const Footer = () => {
    const { isEnglish, isContactPage, setIsContactPage } = useContext(TranslationContext);
    ...
    return ( 
        <>
            {translation && <footer style={{overflowX: "hidden"}} id="foot">
                <div className="row flex-container2 ms-auto me-auto footer-row mt-5 p-0" style={{maxWidth: "90%"}}>
                    ...
                    <div className="col-4 footer-col ps-5">
                        <p className="mb-3 footer-title">{translation.usefulLinks}</p>
                        <div className="position-relative footer-text">
                            <p><a className="footer-link" href="#" style={{color: "#C30606"}}>{translation.beDriver}</a></p>
                            <p><a className="footer-link" href="#">{translation.incident}</a></p>
                            <p><a className="footer-link" href="#">{translation.lOrS}</a></p>
                            <p><a className="footer-link" href="#">{translation.terms}</a></p>
                        </div>
                    </div>
                    <div className="col-4 footer-col h-100 ps-5">
                        <p className="mb-3 footer-title">{translation.comm}</p>
                        <div className="position-relative footer-text">
                            <p>{translation.days}</p>
                            <p>1-800-000-0000 ({translation.qc})</p>
                            <p>1-800-000-0001 ({translation.else})</p>
                        </div>
                    </div>
                    <div className="col footer-col h-100"></div>
                </div>
                <div className="d-flex row" style={{backgroundColor: "black"}}>
                    <div className="row ms-auto me-auto mt-2 mb-2 footer-brand-row" style={{maxWidth: "90%"}}>
                        <div className="col col-two justify-content-start d-flex" style={{color: "#FAF8EF"}}>
                            <p className="footer-title my-auto">2023 CarPoolCITY {translation.rights}.</p>
                        </div>
